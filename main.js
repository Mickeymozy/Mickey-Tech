...
const { shayariCommand } = require('./commands/grouplink');
...
global.channelLink = "https://whatsapp.com/channel/0029VbAcgfWDOQIUP4y8PN0P";
global.ytch = "Mickeydady";
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const channelId = welcomeData?.channelId || '120363422552152940@newsletter';
        ...
        if (action === 'remove') {
            ...
            const channelId = goodbyeData?.channelId || '120363422552152940@newsletter';
